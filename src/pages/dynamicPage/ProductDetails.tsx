			...
			<div className="flex">
				...
				<div className="flex flex-col w-1/2">
					<h1 className="text-xl font-semibold mb-2 ">
						Nestle Coffee Mate CDP 1X1.400gm
					</h1>
					<p className="text-gray-400  text-md mb-2 ">
						SKU Number 11112222611.0
					</p>
					<p className=" text-md font-semibold mb-2 ">
						Nestle Coffee Mate CDP 1X1.400gm
					</p>
					<p className="text-md font-bold mb-4">
						Price: <span className="text-xl font-bold">$19.99</span>{" "}
						...
						{longDescriptionOpen && (
							<div className=" mt-2 text-gray-400">
								<p>
									...
									at dolor nec nunc elementum imperdiet vel id ante. Maecenas
									lacinia.
								</p>
								{/* Add more long description content here */}
							</div>
						)}
					</div>
				</div>
